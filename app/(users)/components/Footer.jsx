    ...
    <footer className="bg-[#0b173c] text-gray-300 py-12 px-6 sm:px-10 lg:px-20 font-inter">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-gray-600 pb-10 mb-8">
          ...
          {/* About Section */}
          <div>
            <h3 className="text-xl font-bold text-white mb-4">Vansh Tyagi</h3>
            <p className="text-sm leading-relaxed mb-4">
              Full Stack Developer passionate about building scalable applications and contributing to
              innovative projects. Currently pursuing Electronics & Communication Engineering at NIT Patna.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="mailto:vansht.ug23.ec@nitp.ac.in" aria-label="Email">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><strong>Email:</strong> <a href="mailto:kapilg.ug23.ee@nitp.ac.in" className="hover:text-white transition-colors duration-300">vansht.ug23.ec@nitp.ac.in</a></li>
              <li><strong>Phone:</strong> <span className="hover:text-white transition-colors duration-300">+91-9012834560</span></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
          <p className="mb-4 md:mb-0">&copy; 2025 Vansh Tyagi. All rights reserved.</p>
